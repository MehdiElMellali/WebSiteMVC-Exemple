...
namespace JobOffersSOA.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult EditProfile()
        {
            ...
            var userEdit = db.Users.Where(a => a.Id == userId).SingleOrDefault();
            EditProfileViewModel profile = new EditProfileViewModel();
            profile.UserName = userEdit.UserName;
        ...
        public ActionResult EditProfile(EditProfileViewModel editProfile)
        {
            ...
            if (!UserManager.CheckPassword(CurrentUser, editProfile.CurrentPassword))
            {
                ViewBag.Message ="Your password not match" ;
            }
            else { 
            var newPasswordHash = UserManager.PasswordHasher.HashPassword(editProfile.NewPassword);
            CurrentUser.UserName = editProfile.UserName;
            CurrentUser.Email = editProfile.Email;
